...
class SimpleDB
{
  ...
  */
  ...
  //--->Insert - Start  
  public function Insert($TableName, $row_arrays = array()  ) 
  { 
    /*
      $insert_arrays = array
      (
  ...
  */  
  ...
  //--->Update - Start
  public function Update($strTableName, $array_fields, $array_where)
  { 
    /*
  ...
  //--->Delete - Start
  public function Delete($strTableName,$array_where)
  {
    /*
  ...
  public function Qry($SQLStatement)
  {
    /*
  ...
  public function CleanHTMLData($Data)
  {
    /*
